    ...
    <>
      ...
      {user && (
        <div className="flex h-12 items-center gap-2 overflow-x-auto border-b border-border/60 bg-muted/30 px-6 md:px-8">
          <Link
            href="/start-here"
            className="inline-flex h-8 shrink-0 items-center gap-1.5 rounded-full bg-foreground px-3 text-xs font-semibold text-background shadow-sm transition hover:bg-foreground/85"
          >
